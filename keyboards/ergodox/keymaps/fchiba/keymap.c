...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_NO,           KC_LALT,       KC_LGUI,  KC_LALT,  KC_NO,
                                                            KC_NO,  KC_NO,
                                                                    KC_NO,
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_DLR,  KC_JGRAVE, KC_JCIRC, KC_JTILD, KC_JYEN,  KC_JPIPE,
                KC_MINS, KC_JQUOT,  KC_PERC,  KC_JLCBR, KC_JLBRC, S(LGUI(KC_JLBRC)),
       KC_TRNS, KC_JEQL, KC_JDQT,   KC_JAMPR, KC_JRCBR, KC_JRBRC, S(LGUI(KC_JRBRC)),
                         KC_TRNS,   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
...
[MDIA] = KEYMAP(
    ...
    // right hand
       ...
       KC_TRNS,  KC_TRNS, KC_WH_U, KC_WH_D, KC_TRNS, KC_MS_U, KC_TRNS,
